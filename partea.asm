...
; Funciones definidas en PARTEB.ASM
...
; Cambia el color de fondo para lo que se escriba con ALT+N (PARTEB.ASM)
...
; Coloca la imagen 2 con ALT+J (PARTEB.ASM)
...
; Muestra la ayuda de atajos con ALT+H (PARTEB.ASM)
...
; Busca y reemplaza texto con ALT+B (PARTEB.ASM)
...
; Guarda el trabajo con ALT+S y regresa al menu principal (sin cerrar el programa)
...
; Deja tambien en SI el indice plano (fila*80+columna), usado para
; ubicar la misma posicion en ATTR_BUFFER (PARTEB.ASM)

PUBLIC GET_BUFFER_POSITION
